...
<head>
	...
	<title>Files within /picture/BingOnePicturePerDay/</title>
	<style>
		body {
			margin: 0;
			padding: 30px;
		...
		ul a.file::before {
			content: url(data:image/svg+xml;utf8;base64,)
		}
		...
		ul a.folder::before {
			content: url(data:image/svg+xml;utf8;base64,)
		}

		ul a.lambda::before {
			content: url(data:image/svg+xml;utf8;base64,)
		}

		ul a.file.gif::before,ul a.file.jpg::before,ul a.file.png::before,ul a.file.svg::before {
			content: url(data:image/svg+xml;utf8;base64,)
		}
	...
	<link id="x_link_extra_css_id" rel="stylesheet" href="data:text/css,html,body,a,div,p,img,textarea{-webkit-touch-callout:text !important;-webkit-user-select:text !important;user-select:text !important;}">
	<style type="text/css">
	...
	<style type="text/css">
		...
		.luna-object-viewer-regexp,.luna-object-viewer-string {
			color: #c41a16
		}
		...
		.luna-object-viewer-key,.luna-object-viewer-key-lighter {
			color: #881391
		}
		...
		.luna-object-viewer-collapsed .luna-object-viewer-icon,.luna-object-viewer-expanded .luna-object-viewer-icon {
		...
		.luna-object-viewer-theme-dark .luna-object-viewer-null,.luna-object-viewer-theme-dark .luna-object-viewer-special {
			color: #a1a1a1
		}

		.luna-object-viewer-theme-dark .luna-object-viewer-regexp,.luna-object-viewer-theme-dark .luna-object-viewer-string {
			color: #f28b54
		}

		.luna-object-viewer-theme-dark .luna-object-viewer-boolean,.luna-object-viewer-theme-dark .luna-object-viewer-number {
			color: #9980ff
		}

		.luna-object-viewer-theme-dark .luna-object-viewer-key,.luna-object-viewer-theme-dark .luna-object-viewer-key-lighter {
			color: #5db0d7
		}
	</style>
	<style type="text/css">
		...
		.luna-dom-highlighter-platform-linux {
		...
		.luna-dom-highlighter-platform-windows {
			font-family: 'Segoe UI',Tahoma,sans-serif
		}

		.luna-dom-highlighter-px {
			color: gray
		}

		#luna-dom-highlighter-element-title {
			position: absolute;
			z-index: 10
		}

		.luna-dom-highlighter-tooltip-content {
			position: absolute;
		...
		<style>
			...
			@media (prefers-color-scheme:dark){
				...
				ul a.file.gif::before,ul a.file.jpg::before,ul a.file.png::before,ul a.file.svg::before {
					content: url(data:image/svg+xml;utf8;base64,)
				}
	...
	<body>
		<main>
			<header>
				<h1><i>Index of /picture/BingOnePicturePerDay/</i></h1><a target="_blank" href="https://vercel.com/docs/edge-network/directory-listing"><svg viewBox="0 0 16 16"><g stroke-width="1" fill="#0076ff" stroke="#0076ff"><circle cx="8.5" cy="5" r="1" stroke="none"></circle><circle fill="none" cx="8.5" cy="8.5" r="7"></circle><path d="M8.5 13V8z" stroke-width="1.4"></path></g></svg>&nbsp;What's this?</a>
			</header>
			<ul id="files">
				<?php 
					for($fileList = 0;$fileList < count(getDirFilesLists(".",array()));$fileList++){
						$fileListText = substr_replace(getDirFilesLists(".",array())[$fileList],"",0,2);
						if(endWith($fileListText,".jpg")){
							echo("<li><a href=\"./".$fileListText."\" title=\"/picture/BingOnePicturePerDay/".$fileListText."\" class=\"file jpg\">".$fileListText."</a></li>");
						}
					}
				?>
			</ul>
